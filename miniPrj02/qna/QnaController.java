...
//	}// method
	...
	private void userEditContent() throws Exception {
		...
		// 결과 처리
			...
			// WRITER_NO 값 불러오기
			String sql2 = "SELECT WRITER_NO FROM QNA WHERE NO = ? ";
			PreparedStatement pstmt2 = conn.prepareStatement(sql2);
			pstmt2.setString(1, no);
			ResultSet result2 = pstmt2.executeQuery();
			String getRNo = "";
			if(result2.next()) {
				getRNo = result2.getString("WRITER_NO");
			}
			if(!getRNo.equals(Main.loginMember.getNo())) {
...
// 7(자기 글 조회
	private void selectQnaOne() throws Exception {
		...
		if (vo == null) {
			System.out.println("자기 글 조회 실패 ...");
			return;
		}
		if (Main.loginMember.getId().equals("ADMIN")) {
			System.out.println("자기 글 조회 성공 !");
			System.out.println("-------------");
			System.out.println("번호 : " + vo.getNo());
			System.out.println("제목 : " + vo.getMasterTitle());
			System.out.println("작성일시 : " + vo.getEnrollDate());
			System.out.println("내용 : " + vo.getMasterContents());
			System.out.println("-------------");
		...
		System.out.println("답변 제목 : " + vo.getMasterTitle());
		System.out.println("답변 내용 : " + vo.getMasterContents());
		System.out.println("-------------");
